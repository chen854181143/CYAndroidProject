package com.chenyang.androidproject.fresco;
...
import com.chenyang.androidproject.utils.StorageUtil;
...
public class FrescoInitUtil {
    ...
    public static void initFrescoConfig() {
        ...
        ImagePipelineConfig pipeConfig = ImagePipelineConfig.newBuilder(MyApplication.getContext())
                ...
                //设置磁盘缓存项配置
                .setMainDiskCacheConfig(getDisCacheConfigDefault(MyApplication.getContext()))
                .setSmallImageDiskCacheConfig(getDisCacheConfigSmall(MyApplication.getContext()))
        ...
        FrescoIniter.initialize(MyApplication.getContext(), pipeConfig);
    ...
    public static class BitmapCacheParamsSupplier implements Supplier<MemoryCacheParams> {
        ...
        public MemoryCacheParams get() {
            ...
            mActivityManager = (ActivityManager) MyApplication.getContext().getSystemService(Context.ACTIVITY_SERVICE);
