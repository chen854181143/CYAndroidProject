 ...
 * ItemDecoration学习列表
 */
public class ItemDecorationStudentListActivity extends MyActivity {
    ...
    protected void initData() {
        ...
        String[] students = getResources().getStringArray(R.array.itemdecoration_student);
        ...
        dialogAdapter.setOnItemChildClickListener(new BaseQuickAdapter.OnItemChildClickListener() {
            ...
            public void onItemChildClick(BaseQuickAdapter adapter, View view, int position) {
                if (position == 0) {
                    startActivity(ItemDecorationStudyOneActivity.class);
                } else if (position == 1) {
                    startActivity(ItemDecorationStudyTwoActivity.class);
                }
            }
        });
    }
