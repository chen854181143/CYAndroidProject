package com.chenyang.androidproject.adapter.global.view;
...
import com.chenyang.androidproject.utils.NetworkUtil;

import static com.chenyang.androidproject.view.gloading.Gloading.STATUS_EMPTY_DATA;
import static com.chenyang.androidproject.view.gloading.Gloading.STATUS_LOADING;
import static com.chenyang.androidproject.view.gloading.Gloading.STATUS_LOAD_FAILED;
import static com.chenyang.androidproject.view.gloading.Gloading.STATUS_LOAD_SUCCESS;
    ...
    public void setStatus(int status) {
        ...
        switch (status) {
            ...
            case STATUS_LOAD_FAILED:
                ...
                Boolean networkConn = NetworkUtil.isNetworkConnected(getContext());
